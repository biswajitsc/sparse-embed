...
--model_dir=checkpoints/msceleb/dense_mobilenet_128_run_1 \
--data_dir=../facescrub/tfrecords_official/ --is_training=False \
--final_activation=none --model=mobilefacenet --debug=False  \
--filelist=../megaface_distractors/facescrub_features_list.json \
--prefix=facescrub
...
--final_activation=none --model=mobilefacenet --debug=False  \
--filelist=../megaface_distractors/megaface_features_list.json_1000000_1 \
--prefix=megaface

python get_embeddings_reranking.py --num_classes=85743 --embedding_size=512 \
--model_dir=checkpoints/msceleb/dense_mobilenet_512_run_1 \
--data_dir=../facescrub/tfrecords_official/ --is_training=False \
--final_activation=none --model=mobilefacenet --debug=False  \
--filelist=../megaface_distractors/facescrub_features_list.json \
--prefix=facescrub
...
--model_dir=checkpoints/msceleb/sparse_mobilenet_fl_run_$i \
--data_dir=../facescrub/tfrecords_official/ --is_training=False \
...
do
python get_embeddings_reranking.py --num_classes=85743 --embedding_size=1024 \
--model_dir=checkpoints/msceleb/sparse_mobilenet_l1_run_$i \
--data_dir=../facescrub/tfrecords_official/ --is_training=False \
--final_activation=relu --model=mobilefacenet --debug=False  \
--filelist=../megaface_distractors/facescrub_features_list.json \
--prefix=facescrub
