...
python train.py \
--model_dir=checkpoints/kubernetes/msceleb/sparse_resnet_dynamic_4_l1_run_4 \
--learning_rate=1e-2 --decay_step=160000 --optimizer=mom --momentum=0.9 \
...
--l1_weighing_scheme=dynamic_4 --l1_parameter=6.0 -l1_p_steps=100000 \
