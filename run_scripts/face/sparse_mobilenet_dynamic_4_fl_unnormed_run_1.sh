...
python train.py \
--model_dir=checkpoints/kubernetes/msceleb/sparse_mobilenet_dynamic_4_fl_unnormed_run_1 \
--learning_rate=1e-2 --optimizer=mom --momentum=0.9 \
...
--l1_weighing_scheme=dynamic_4 --l1_parameter=2.0 \
